...
Coupon-Daten laden und in Objekt schreiben
Alle Daten aus dem ersten Objekt drucken
...
// DOM load
    ...
    document.getElementById('showCouponBtn').addEventListener('click', showCoupon);
